...
import datetime
import sys
#make sure to match value of y1 in make_points function with th value of y_offset and check the result
_SHOW_IMAGE = False
...
def detect_line_segments(cropped_edges):
    ...
    line_segments = cv2.HoughLinesP(cropped_edges, rho, angle, min_threshold, np.array([]), minLineLength=40,
                                    maxLineGap=5)
...
def make_points(frame, line):
    ...
    y2 = int(y1 * 0.7)  # make points from middle of the frame down
